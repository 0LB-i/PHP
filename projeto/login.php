...
<body>
    ...
    ?>
    <form class="form-signin" method="post" action="action/actions_login.php">
        ...
        <input type="text" name="user" class="form-control mb-2" placeholder="Usuário" required autofocus>
